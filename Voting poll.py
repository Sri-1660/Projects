...
while True:
    if voter_id == []: 
        ...
        if nm1_votes> nm2_votes:
            ...
            print("Both have equal number of votes!!! GOvernment will decide the ruling party")
            break
    ...
    if voter in voter_id:
        ...
        if vote == 1:
            nm1_votes +=1
            print(nominee1, "Thank you for your important vote to them!")
        elif vote == 2:
            nm2_votes +=1
            print(nominee2, "Thank you for your important vote to them!")
        elif vote > 2:
            print("Check your pressed key!")
        else : 
            print("You are a voter OR You have already voted")
